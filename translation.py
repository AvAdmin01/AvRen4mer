...
<b>Bot Maintained By: @myAntraxx </b> \n 
"""

    RENAME_403_ERR = "What Are You Doing? Bruuh!!"
    BANNED_USER_TEXT = "Sorry!! But Mah Owner As Banned You From Using This Service. That Means You Can't Run Meh Now! \n \n Contact : @imAvAdmin For more Details.. " 
    ABS_TEXT = "What Are You Trying To Do,Mate?"
    UPGRADE_TEXT = "CONTACT @Antr4xx"
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "<b>Thank you for Using Me Support Our Channel @myAntraxx</b>"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds"
    NOT_AUTH_USER_TEXT = "CONTACT @Antr4xx"
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @Antr4xx "
